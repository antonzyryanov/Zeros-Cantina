...
final class Zeros_CantinaTests: XCTestCase {
    ...
    func test_WhenTabBarButtonTapped_ThenItChangesColor() {
        ...
        let tabBarCustomConfiguration = CustomTabBarConfiguration(backgroundColor: .white, borderColor: .red, buttonsColor: .red, borderWidth: 2, cornerRadius: 16, buttonsCornerRadius: 12, buttons: [CustomTabBarButtonModel(title: "Foo", image: UIImage(named: "home_icon")!, action: {
            
        }),
                                                                                                                                                                                                       CustomTabBarButtonModel(title: "Bar", image: UIImage(named: "home_icon")!, action: {
                                                                                                                                                                                                       })
                                                                                                                                                                                                      ])
